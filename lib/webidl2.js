...
(function () {
    ...
    var parse = function (tokens) {
            ...
            if (ret.optional) {
                ...
                if (consume("other", "=")) {
                    ...
                    if (typeof def !== "undefined") {
                        ...
                        ret["default"] = consume("string") || error("No value for argument default");
                    }
                }
            }
            return ret;
        ...
        var exception = function () {
            ...
            if (consume("other", ":")) {
                all_ws();
                var inh = consume("identifier") || error ("No type in exception inheritance");
                ret.inheritance = inh.value;
                all_ws();
            }
