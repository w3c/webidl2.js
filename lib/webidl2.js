...
(() => {
  ...
  function parse(tokens) {
    ...
    function callback() {
      ...
      if (tok) {
        ret = interface_rest(null, "callback interface");
    ...
    function interface_rest(isPartial = null, typeName = "interface") {
    ...
    function mixin_rest(isPartial = null) {
    ...
    function interface_(isPartial = null) {
    ...
    function namespace(isPartial = null) {
    ...
    function partial() {
      ...
      if (!token) return;
      const isPartial = { trivia: token.trivia };
      return dictionary(isPartial) ||
        interface_(isPartial) ||
        namespace(isPartial) ||
        error("Partial doesn't apply to anything");
    }

    function dictionary(isPartial = null) {
