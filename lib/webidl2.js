...
(function () {
    /**
     * Split a string into {@link Token}s.
     * @private
     * @param {string} str
    ...
    /**
     * Construct a {@link WebIDLParseError}.
     * @class
     ...
     */
    function WebIDLParseError(message /* : string */, line /* : number */, input /* : string */, tokens /* : Array<Token> */) {
    ...
    /**
     * Parse {@link IDLDefinition}s.
     * @private
     * @param {Array<Token>} tokens
     * @param {ParseOptions} opt
     * @returns {Array<IDLDefinition>}
     * @throws {WebIDLParseError}
     */
    function parse(tokens /* : Array<Token> */, opt /* : ParseOptions */) {
        ...
        /**
         * Consume a {@link Token} of a particular {@link TokenType}. If a
         * value is provided, this method will only consume the {@link Token}
         * if its own value matches.
         * @private
        ...
        /**
         * Consume a single whitespace {@link Token}.
         * @private
         * @returns {?Token}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Consume as many whitespace {@link Token}s as possible.
         * @private
         * @returns {?Token}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse a constant {@link IDLValue}.
         * @private
         * @returns {?IDLValue}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse {@link IDLArgument}s.
         * @private
         * @returns {?Array<IDLArgument>}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse a pair of {@link IDLType}s.
         * @private
         * @returns {?Array<IDLType, IDLType>}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLExtendedAttribute}.
         * @private
         * @returns {?IDLExtendedAttribute}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse {@link IDLExtendedAttribute}s.
         * @private
         * @returns {Array<IDLExtendedAttribute>}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLConstantMember}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLConstantMember}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse the name and arguments for an {@link IDLOperationMember} or
         * an {@link IDLSerializerOperationMember}.
         * @private
         * @returns {?{ name: ?string, arguments: Array<IDLArgument> }}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLCallback} or {@link IDLCallbackInterface}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLCallback|IDLCallbackInterface}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLAttributeMember}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLAttributeMember}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse the return type of an {@link IDLCallback}, an
         * {@link IDLOperationMember}, or an {@link IDLIteratorMember}.
         * @private
         * @returns {?IDLType|string} - undefied, an IDLType, or "void"
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLIteratorMember} or an {@link IDLOperationMember}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLIteratorMember|IDLOperationMember}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLNamedSerializerMember}, an
         * {@link IDLSerializerMember}, an {@link IDLSerializerOperationMember},
         * an {@link IDLSerializerPatternListMember}, or an
         * {@link SerializerPatternMapMember}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLNamedSerializerMember
         *          | IDLSerializerMember
         *          | IDLSerializerOperationMember
         *          | IDLSerializerPatternListMember
         *          | ISLSerializerPatternMapMember }
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse a {@link ReadonlyIterableType}.
         * @private
         * @returns {?ReadonlyIterableType}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLIterableMember}, an
         * {@link IDLLegacyIterableMember}, an {@link IDLMaplikeMember}, or an
         * {@link IDLSetlikeMember}.
         * @private
         * @param {boolean} isPartial
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLIterableMember
        ...
        /**
         * Parse an {@link IDLInterface}.
         * @private
         * @param {boolean} isPartial
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLInterface}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse a partial {@link IDLDictionary} or {@link IDLInterface}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLDictionary|IDLInterface}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLDictionary}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLDictionary}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLException}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLException}
         * @throws {WebIDLParseError}
         */
        ...
        /**
         * Parse an {@link IDLImplements}.
         * @private
         * @param {Array<IDLExtendedAttribute>} ea
         * @returns {?IDLImplements}
         * @throws {WebIDLParseError}
         */
