...
(() => {
  ...
  function parse(tokens) {
    ...
    class Identifier {
      ...
      get separator() {
        const { separator } = this.tokens;
        if (!separator) {
          return null;
        }
        const { value, trivia } = separator;
        return { value, trivia };
      }
    ...
    class IterableLike {
      ...
      get readonly() {
        const { readonly } = this.tokens;
        if (!readonly) {
          return null;
        }
        return { trivia: this.tokens.readonly.trivia };
      }
      get trivia() {
        return {
    ...
    class Interface {
      constructor(base, { callback = null, partialModifier = null } = {}) {
        const name = consume(ID) || error("No name for interface");
        Object.defineProperty(this, "tokens", {
          value: { callback, base, name }
        });
        this.partial = partialModifier;
        current = this;
        if (!partialModifier) {
    ...
    class Mixin {
      constructor(base, { partialModifier = null } = {}) {
    ...
    class Namespace {
      constructor({ partialModifier = null } = {}) {
    ...
    function partial() {
      ...
      return tryParse(Dictionary, { partialModifier }) ||
        interface_({ partialModifier }) ||
        tryParse(Namespace, { partialModifier }) ||
    ...
    class Field {
      ...
      get required() {
        const req = this.tokens.required;
        if (!req) {
          return null;
        }
        const { trivia } = req;
    ...
    class EnumItem {
      ...
      get separator() {
        const sep = this.tokens.separator;
        if (!sep) {
          return null;
        }
        const { value, trivia } = sep;
        return { value, trivia };
      }
