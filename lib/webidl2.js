...
(function () {
    ...
    function parse(tokens /* : Array<Object> */, opt) {
        var line = 1;
        tokens = tokens.slice();
        ...
        function interface_(isPartial, ea) {
            var ret = {};
            ret.type = "interface";
            ret.partial = false;
            ret.members = [];
        ...
        function dictionary(isPartial, ea) {
            var ret = {};
            ret.type = "dictionary";
            ret.partial = false;
            ret.members = [];
