...
/** @typedef {'callback-interface'|'dictionary'|'interface'|'mixin'|'namespace'} ExtendableInterfaces */
/** @typedef {Object.<'extMembers', import("./container.js").AllowedMember[]>} Extension */
 ...
 * @param {Object.<ExtendableInterfaces, Extension>} [options.extensions]
 */
  ...
  function callback() {
    ...
    if (tokeniser.probe("interface")) {
      return CallbackInterface.parse(tokeniser, callback, {
        ...options?.extensions?.["callback-interface"],
      });
    }
