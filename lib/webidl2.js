...
(() => {
  ...
  function parse(source) {
    ...
    function single_type(typeName) {
      const ret = Object.assign({ type: null }, EMPTY_IDLTYPE, { trivia: {} });
      const base = GenericType.parse(typeName) || primitive_type();
      if (base) {
        Object.assign(ret, base.generic ? base.toJSON() : base);
      } else {
