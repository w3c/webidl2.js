...
export class Type extends Base {
  ...
  *validate(defs) {
    ...
    // if (this.nullable && this.union) {
    //   for (const subtype of this.subtype) {
    //     if (subtype.nullable )
    //     const def = defs.unique.get(subtype.idlType);
    //     if (def && def.type === "dictionary") {
    //       const message = `Nullable union cannot include a dictionary type`;
    //       yield validationError(this.source, dict.tokens.base, this, message);
    //     }
    //   }
    //   // const typedef = !this.union && defs.unique.get(this.idlType);
    //   // const target =
    ...
    //   //   if (reference) {
    //   //     const message = `Nullable union cannot include a dictionary type`;
    //   //     yield validationError(this.source, reference.tokens.base, this, message);
    //   //   }
    //   // }
    // }
  }
