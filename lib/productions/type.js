...
function union_type(tokeniser, type) {
  ...
  ret.type = type || null;
  while (true) {
    if(tokeniser.probe("any")) tokeniser.error("Type `any` cannot be included in a union type");
    if(tokeniser.probe("promise")) tokeniser.error("Type `Promise` cannot be included in a union type")
